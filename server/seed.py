...
ACCOUNTS = [
    {
        ...
        "note": "Publish, delete ANY case, comment, manage users, read audit log.",
    },
    {
        ...
        "license_country": "India",
        "note": "Publish, comment, and delete ONLY their own cases.",
    },
    {
        ...
        "note": "Browse and search only. Cannot publish, comment or delete.",
    },
]
...
def write_accounts_file():
    ...
    lines += [
        ...
        "=" * 66,
        "",
        " Roles are enforced. Each account can do exactly this:",
        "",
        "   ADMIN         publish · delete ANY case · comment ·",
        "                 manage users · read the audit log",
        "   CONTRIBUTOR   publish · delete ONLY their own cases · comment",
        "   READ-ONLY     browse and search. Cannot publish, comment,",
        "                 or delete anything.",
        "",
        " A contributor attempting to delete another dentist's case gets a",
        " 403, and the Delete button is not shown to them in the first place.",
        "",
        " To bypass all checks while debugging (NOT the default):",
        "",
        "   PowerShell:   $env:DENTAL_INFO_PERMISSIVE=1 ; python server/app.py",
        "   bash:         DENTAL_INFO_PERMISSIVE=1 python server/app.py",
        "",
        "=" * 66,
        " RESET",
        "=" * 66,
